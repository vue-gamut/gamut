...
import { SectionProps } from "@vue-types/collections";

function Section<T>(props: SectionProps<T>): VNode | null {
...
let _Section = Section as <T>(props: SectionProps<T>) => VNode | null;
